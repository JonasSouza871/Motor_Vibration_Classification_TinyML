...
firmware/
├── libs/                     # Header files
│   ├── motor_model.h         # TFLite model array (generated by notebook)
│   ├── scaler_params.h       # Normalization parameters (generated by notebook)
│   ├── mpu6050.h             # MPU6050 sensor driver
│   ├── ssd1306.h             # SSD1306 OLED display driver
│   └── font.h                # Font bitmap for display
│
├── src/                      # Source files
│   ├── main.c                # Main application
│   ├── mpu6050.c             # MPU6050 implementation
│   └── ssd1306.c             # SSD1306 implementation
│
└── README.md                 # This file
```
...
- ✅ Real-time MPU6050 sensor reading (accelerometer + gyroscope)
- ✅ I2C communication at 400 kHz
- ✅ SSD1306 OLED display with custom font rendering
- ✅ Sensor data visualization on display
- ✅ 200ms refresh rate
- 🔄 TinyML inference (upcoming)
...
🔄 **TinyML integration in progress**
